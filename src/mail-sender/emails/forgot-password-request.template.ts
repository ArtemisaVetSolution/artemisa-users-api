export const resetPasswordEmailTemplate = (name: string, url: string) => {
    return `
        ...
        <div style="max-width: 600px; margin: 40px auto; padding: 20px; border: 1px solid #ddd; border-radius: 5px;   box-shadow: 0px 3px 12px rgb(47 43 61 / 0.14);" >
            ...
            <img src="URL_DEL_LOGO" alt="Logo de Artemisa" style="width: 100px; height: auto;">
            </div>
            ...
            <p style="color: #333;">Este enlace es válido por 24 horas. Si no solicitaste restablecer tu contraseña, puedes ignorar este mensaje.</p>
